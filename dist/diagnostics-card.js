...
static get styles() {
  ...
  render() {
    ...
    // These strings must match exactly how they appear in your HA (after the slug)
    const state_of_charge_percent = this._getSensorValue("state_of_charge_percent", { asInteger: true });
    const battery_state = this._getSensorValue("battery_state");
    ...
    const yOffset = 108.65 + (maxHeight - fillHeight);
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="81.195" height="61.654" version="1.1" viewBox="0 0 100 100" xml:space="preserve">
            ...
            <g transform="translate(-86.291 -91.563)">
              <g id="battery_charging" transform="matrix(4.4677 0 0 4.4677 -279.77 -310.09)" display="${charging_state}">
                <text id="time_to_90_percent" x="104.62045" y="93.666908" fill="#000000" font-size=".88194px" stroke-linecap="round" stroke-width=".050248" text-align="center" text-anchor="middle" xml:space="preserve">${time_to_90_percent}</text>
                ...
                <g transform="translate(-1.1508 11.431)" fill="none" stroke="#000">
                ...
                <g transform="translate(-2.6925 14.922)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round">
                ...
                <text id="solar_to_battery_kw" x="105.10344" y="99.257202" fill="#000000" font-size="1.0583px" stroke-linecap="round" stroke-width=".050248" text-align="center" text-anchor="middle" xml:space="preserve">${solar_to_battery_kw}</text>
                <text id="grid_to_battery_kw" x="105.10343" y="101.58399" fill="#000000" font-size="1.0583px" stroke-linecap="round" stroke-width=".050248" text-align="center" text-anchor="middle" xml:space="preserve">${grid_to_battery_kw}</text>
              </g>
              <g id="battery_discharging" transform="matrix(4.4677 0 0 4.4677 -327.05 -310.09)" display="${discharging_state}">
                <text id="time_to_15_percent" x="115.20378" y="93.666908" fill="#000000" font-size=".88194px" stroke-linecap="round" stroke-width=".050248" text-align="center" text-anchor="middle" xml:space="preserve">${time_to_15_percent}</text>
                <g transform="translate(9.9386 10.953)" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width=".1">
                ...
                <g transform="translate(7.8908 14.922)" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round">
                  <g stroke-width=".11905">
                    <path d="m103.87 87.66h1.1388"/>
                    <path d="m104.81 87.66-0.19028-0.70844-0.10246-0.81969-0.0966-0.202-0.10246 0.21956-0.079 0.81676-0.16979 0.69381"/>
                    <path d="m104.7 87.251-0.63078 0.40908"/>
                ...
                <g>
                  ...
                  <text id="battery_to_house_kw" x="115.68677" y="99.257202" fill="#000000" font-size="1.0583px" stroke-linecap="round" stroke-width=".050248" text-align="center" text-anchor="middle" xml:space="preserve">${battery_to_house_kw}</text>
                  <text id="battery_to_grid_kw" x="115.68677" y="101.58399" fill="#000000" font-size="1.0583px" stroke-linecap="round" stroke-width=".050248" text-align="center" text-anchor="middle" xml:space="preserve">${battery_to_grid_kw}</text>
                </g>
              </g>
              <g>
              ...
              <g id="battery_temperature_low" transform="matrix(.82909 0 0 .82909 -5.6173 31.533)" display="none">
              ...
              <g id="battery_temperature_high" transform="matrix(.82909 0 0 .82909 6.5755 28.024)" display="none">
                <g stroke="#000">
              ...
              <g id="battery_temperature_nominal" transform="matrix(5.0722 0 0 5.0722 -429.31 -276.86)" stroke="#000">
...
render() {
    ...
    const schema = [
      {
        name: "device_id",
        label: "Select your Kotiakku Device",
        selector: { 
          device: { 
...
customElements.define("elisa-kotiakku-diagnostics-editor", ElisaKotiakkuDiagnosticsEditor);