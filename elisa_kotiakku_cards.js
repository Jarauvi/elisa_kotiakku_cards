...
static get styles() {
  ...
  render() {
    ...
    return html`
      <ha-card>
        <div class="container">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="87.48" height="69.2" version="1.1" viewBox="0 0 107.74 112.24" xml:space="preserve">
            <defs>
              ...
              <linearGradient id="linearGradient82" x1="90.336" x2="216.59" y1="103.54" y2="102.81" gradientTransform="translate(5.6553)" gradientUnits="userSpaceOnUse">
                <stop stop-color="#6fccff" offset="0"/>
                <stop stop-opacity="0" offset="1"/>
              </linearGradient>
            </defs>
            <g transform="translate(-102.84 -97.165)">
              <path  display="${idle_state}" style="animation:${charging_animation}" d="m97.217 109.91v-2.5247c0.30122-3.5582 2.2117-5.3283 5.7314-5.3103h119.3" fill="none" stroke="url(#linearGradient82)" stroke-dasharray="1.22605, 1.22605" stroke-linejoin="round" stroke-width="2.4521"/>
              <rect x="177.29" y="109.61" width="45.114" height="55.687" fill-opacity=".40519"/>
              <g id="battery_charging" transform="matrix(4.4677 0 0 4.4677 -264.31 -288.03)" display="${charging_state}">
              ...
              <g id="battery_discharging" transform="matrix(4.4677 0 0 4.4677 -311.59 -288.03)" display="${discharging_state}" stroke-linecap="round">
                ...
                <g transform="translate(10.665 8.7752)" stroke="#fff" stroke-linejoin="round" stroke-width=".1">
                  <path d="m100.13 88.943h1.5701" fill="#2c0"/>
                  <g fill="none">
                    <path d="m100.3 88.943v-1.0552l-0.14385 0.11066-0.0664-0.11434 0.82888-0.60861 0.83097 0.61968-0.0664 0.10328-0.15123-0.11066v1.0552"/>
                    <path d="m100.3 87.888 0.61967-0.46476 0.6123 0.46476"/>
                    <path d="m100.83 88.943v-0.55033h-0.34689v0.55033"/>
                    <rect x="100.75" y="87.798" width=".32863" height=".32602"/>
                    <rect x="101.02" y="88.39" width=".32602" height=".3182"/>
                    <path d="m100.72 88.632v0.07564"/>
                    <path d="m101.18 88.39v0.3182"/>
                    <path d="m100.91 87.798v0.32603"/>
                    <path d="m101.25 87.525v-0.16277h0.18109v0.29782"/>
                  </g>
                </g>
              ...
              <path d="m173.11 204.14-5.2e-4 -94.231h-62.528l5.8e-4 94.231z" fill="url(#linearGradient32)"/>
              ...
              <rect id="battery_gauge_bg" x="92.95" y="109.91" width="8.5356" height="99.491" fill="#cecece" stroke="#000" stroke-width=".61178"/>
              ...
              <g fill="#000000" stroke-linecap="round" stroke-width=".30741" text-anchor="middle">
                ...
                <text id="battery_state" fill="#ffffff" x="200.49507" y="116.48349" font-size="6.4746px" text-align="center" xml:space="preserve">${battery_state}</text>
              </g>
              <text id="battery_power_kw" x="200.28651" y="126.45637" fill="#ffffff" font-size="5.4065px" stroke-linecap="round" stroke-width=".30741" text-align="center" text-anchor="middle" xml:space="preserve">${battery_power_kw}</text>
              ...
              <rect x="85.712" y="198.13" width="23.01" height="11.277" fill-opacity=".40519"/>
              <text id="state_of_charge_percent" x="97.421089" y="204.12335" fill="#ffffff" font-size="6.4746px" stroke-width=".16857" text-align="center" text-anchor="middle" xml:space="preserve">${state_of_charge_percent}</text>
            </g>
          </svg>
        </div>
      </ha-card>
